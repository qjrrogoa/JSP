...
<link href="<%=request.getContextPath()%>/Styles/DivLayout.css"
	...
	<script>
		var isDelete = function(){
			if(confire("정말로 삭제 하시겠습니까?"))
				location.replace("Delete.jsp?no=<%=dto.getNo()%>");
		};
						...
						<fieldset>
							...
							<table width="75%" bgcolor="gray" cellspacing="1">
								...
								<tr bgcolor="white" align="center">
									...
									<a href="Edit.jsp?no=<%=dto.getNo() %>">수정</a>| <a href = "javascript:isDelete()">삭제</a> | 
									<% }//if %>
							...
							<table style="width: 75%">
								<tr>
									...
									<td><%=map.get("PREV")==null ? "이전 글이 없습니다." : String.format("<a href='View.jsp?no=%s'>%s</a>",map.get("PREV").getNo(),map.get("PREV").getTitle()) %></td>
								</tr>
								<tr>
