...
<body>
	<fieldset>
		...
		<%=response.containsHeader("content-type") ? "Content-Type존재": "Content-Type 미존재"%>
		<h4>currentDate존재 여부 판단</h4>
		<%=response.containsHeader("currentDate") ? "currentDate존재": "currentDate 미존재"%>
	</fieldset>
</body>
</html>