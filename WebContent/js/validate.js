...
/*
    ...
    */
    function isValidate(obj){
        ...
        console.log('%O',obj.gender);//RadioNodeList
        //일반 for문
        /*
        ...
        var count=0;
        //체크안된 체크 박스중 처음 꺼에 포커스를 주기위한 코드 추가
        var notChecked =[];//체크 안된 체크박스들의 인덱스 저장

        console.log('%O',obj.inter);//RadioNodeList
        ...
        notChecked.forEach(function(e){console.log(e)});
       
        if(count <3 ){
            alert('관심사항은 3개 이상을 선택하세요');
